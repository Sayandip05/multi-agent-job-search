...
if __name__ == "__main__":
    """
    Test the resume analysis agent with a sample resume.
    
    Run: python -m src.agents.resume_analyst
    """
    ...
    Experienced Software Engineer with 4 years of expertise in Python, 
    machine learning, and web development. Proven track record of building 
    scalable applications and leading small teams.
    
    EXPERIENCE
    Senior Software Engineer | TechCorp Inc. | 2022-Present
    - Lead development of ML-powered recommendation system
    ...
    SKILLS
    Programming: Python (4 years), JavaScript (2 years), SQL (3 years)
    Frameworks: FastAPI, Flask, React, TensorFlow
    Tools: Docker, Git, AWS, PostgreSQL
    Soft Skills: Team Leadership, Agile Development
    """
    ...
    try:
        ...
        print(f"Total Years: {profile.total_years_experience}")
        print(f"\nSkills Extracted: {len(profile.skills)}")
        ...
        print(f"Companies: {', '.join(profile.previous_companies)}")
        ...
        print(f"And the model is pulled: ollama pull {settings.ollama.model}")